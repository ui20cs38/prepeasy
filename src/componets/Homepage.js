    ...
    <div className="element-container">
      ...
      <span className="float-element">
        <i className="material-icons">edit_square</i>
                    ...
                    <h1>
                      THE <span className="text-warning">SUGGETION MASTER</span>{" "}
                      for you
                    </h1>
                  </div>
                </div>
            ...
            <div className="about-image-wrap h-100">
              ...
              <div className="about-image-info">
                ...
                <p className="text-white mb-0">
                  You can freely use Prep Easy for your prepartion.
                  Thank you for visiting Prep Easy.
                </p>
              </div>
            </div>
          </div>
          <div className="col-lg-6 col-12 d-flex flex-column">
            <div className="about-thumb bg-white shadow-lg">
              <div className="about-info">
                ...
                <p>
                  Prep Easy is easy tool for students to find relevent study material on topic in three varous forms video, pdf and hanndwritten notes.
                  Prep Easy is blessing for many students. 
                </p>
                <p>
                  Students can reduce their preparation time by finding best study material on topic with just few clicks.
                  Thank you.
                </p>
              </div>
            </div>
            <div className="row h-100">
              ...
              <div className="col-lg-6 col-6">
                <div className="about-thumb d-flex flex-column justify-content-center bg-warning mb-lg-0 h-100">
                  <div className="about-info">
                    <h5 className="text-white mb-4">Is it complicated to use Prep Easy?</h5>
                    <p className="text-white mb-0">
